...
import os
import time
from pipeline.cp_dataset import CPDataset, CPDataLoader
from pipeline.networks import GMM, UnetGenerator, load_checkpoint

from tensorboardX import SummaryWriter
from pipeline.visualization import board_add_image, board_add_images, save_images


def get_opt(mode):
    parser = argparse.ArgumentParser()

    parser.add_argument("--name", default=mode)
    ...
    parser.add_argument("--stage", default=mode)
...
def test_gmm(opt, test_loader, model, board):
    ...
    save_dir = os.path.join('data', opt.datamode)
