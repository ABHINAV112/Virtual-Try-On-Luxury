...
def open_pose(image_path):
    ...
    protoFile = f'{OPENPOSE_BASEURL}/models/pose/body_25/pose_deploy.prototxt'
    weightsFile = f'{OPENPOSE_BASEURL}/models/pose/body_25/pose_iter_584000.caffemodel'
    nPoints = 18
    # COCO Output Format
...
if __name__ =="__main__":
    image_path =f'{OPENPOSE_BASEURL}/examples/media/COCO_val2014_000000000241.jpg'
    open_pose(image_path)